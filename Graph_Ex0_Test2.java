...
public class Graph_Ex0_Test2 {
    ...
    /**
     * Generate a random ex0.graph with v_size nodes and e_size edges
     * @param v_size
     * @param e_size
     * @param seed
     * @return
    ...
    /**
     * ex0.graph with two nodes and no edges - not connected
     */
    ...
    /**
     * ex0.graph with two nodes and a single edge - connected
     */
    ...
    /**
     * small ex0.graph test (|V|=10, |E|=30), remove edges and a node:
     * so the updates ex0.graph will have (|V|=9, |E|=21)
     */
    ...
    /**
     * testing ex0.graph generation and connectivity
    ...
    /**
     * test connectivity & shortest path of a double-list like ex0.graph
     * @param size
     * @param seed
     */
    ...
    /**
     * Simple method for returning an array with all the ex0.node_data of the ex0.graph,
